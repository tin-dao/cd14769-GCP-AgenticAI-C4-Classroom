...
def datastore_search_tool( search_query: str ):
    """
    Searches bank documents for the requested information.

    Args:
        search_query (str): requested information such as loan policy, customer rating, or customer profile information.
    """
    return search(
